...
<head>
    ...
    <title>Espace Etudiant | PEESo</title>
...
<style>
    ...
    .details-disabled .block-item{
        cursor: auto !important;

    }
    .details-disabled .detail-titre-item{
        color: #0000009c;
    }
    .details-disabled .detail-accordion-item{
        ...
        .activity-wrapper .devoir {
            box-shadow: 0 1px 2px 0 rgba(60, 64, 67, .3), 0 2px 6px 2px rgba(60, 64, 67, .15);
            border-radius: .5rem;
            overflow: hidden;
            padding: 1.5rem;
        }
        .devoir .choose-file-button {
            cursor: pointer;
            color: var(--primaryColor);
            font-weight: 700;
            border: 2px solid var(--gm-hairlinebutton-outline-color, rgb(218, 220, 224));
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-12">
                                <div class="dashboard__inner sticky-top">
                                        ...
                                        <ul>
                                            ...
                                            <li class="toggle-menu-item">
                                                ...
                                                <div class="menu-item-children collapse in" id="gestion_demande">
                                                    <a style="font-size: 0.9rem;" href="<?=base_url('demande_formation__etudiant')?>">
                                            ...
                                            <li>
                                                <a href="<?=base_url('all_formations_student')?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <li>
                                                <a href="<?=base_url('randez_vous_etudiant')?>">
                                    ...
                                    <div class="dashboard__nav">
                                        <ul>
                                            <li>
                                                <a href="<?=base_url('misejour_compte_etudiant')?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
