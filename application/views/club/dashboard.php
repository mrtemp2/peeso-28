                                ...
                                <div class="row">
                                        ...
                                        <div class="dashboard__single__counter">
                                            <div class="counterarea__text__wraper">
                                                <div class="counter__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/counter/counter__1.png" alt="counter">
                                                </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-12">
                                        <div class="dashboard__single__counter">
                                            <div class="counterarea__text__wraper">
                                                <div class="counter__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/counter/counter__2.png" alt="counter">
                                                </div>
                                                <div class="counter__content__wraper">
                                                    <div class="counter__number">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-12">
                                        <div class="dashboard__single__counter">
                                            <div class="counterarea__text__wraper">
                                                <div class="counter__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/counter/counter__3.png" alt="counter">
                                                </div>
                                                <div class="counter__content__wraper">
                                                    <div class="counter__number">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-12">
                                        <div class="dashboard__single__counter">
                                            <div class="counterarea__text__wraper">
                                                <div class="counter__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/counter/counter__4.png" alt="counter">
                                                </div>
                                                <div class="counter__content__wraper">
                                                    <div class="counter__number">
                                        ...
                                        <div class="dashboard__popular__instructor">
                                            ...
                                            <div class="dashboard__popular__instructor__single">
                                                <div class="dashboard__popular__instructor__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/teacher/teacher__1.png" alt="">
                                                </div>
                                            ...
                                            <div class="dashboard__popular__instructor__single">
                                                <div class="dashboard__popular__instructor__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/teacher/teacher__2.png" alt="">
                                                </div>
                                                <div class="dashboard__popular__instructor__content">
                                                    <h4>
                                            ...
                                            <div class="dashboard__popular__instructor__single">
                                                <div class="dashboard__popular__instructor__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/teacher/teacher__3.png" alt="">
                                                </div>
                                                <div class="dashboard__popular__instructor__content">
                                                    <h4>
                                                        <a href="../instructor-details.html">Nidmjae Mollin</a>
                                            ...
                                            <div class="dashboard__popular__instructor__single">
                                                <div class="dashboard__popular__instructor__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/teacher/teacher__4.png" alt="">
                                                </div>
                                                <div class="dashboard__popular__instructor__content">
                                                    <h4>
                                            ...
                                            <div class="dashboard__popular__instructor__single">
                                                <div class="dashboard__popular__instructor__img">
                                                    <img loading="lazy"  src="<?=base_url()?>public/new/img/teacher/teacher__5.png" alt="">
                                                </div>
                                                <div class="dashboard__popular__instructor__content">
                                                    <h4>
                                                        <a href="../instructor-details.html">Sndi Jac</a>
                                        ...
                                        <div class="dashboard__recent__course">
                                            <div class="dashboard__recent__course__single">
                                                <div class="dashboard__recent__course__img">
                                                    <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/grid/grid_1.png"
                                                            alt="grid"></a>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <i class="icofont-teacher"></i> <a
                                                                    href="../instructor-details.html">Jon Ron</a>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="dashboard__recent__course__single">
                                                <div class="dashboard__recent__course__img">
                                                    <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/grid/grid_2.png"
                                                            alt="grid"></a>
                                            ...
                                            <div class="dashboard__recent__course__single">
                                                <div class="dashboard__recent__course__img">
                                                    <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/grid/grid_3.png"
                                                            alt="grid"></a>
                                            ...
                                            <div class="dashboard__recent__course__single">
                                                <div class="dashboard__recent__course__img">
                                                    <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/grid/grid_4.png"
                                                            alt="grid"></a>
                                                ...
                                                <div class="dashboard__recent__course__content">
                                                    ...
                                                    <div class="dashboard__recent__course__meta">
                                                        <ul>
                                                            <li>
                                                                <i class="icofont-teacher"></i> <a
                                                                    href="../instructor-details.html">Mini Ron</a>
                                                            </li>
                                                            <li>
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                                <div class="dashboard__content__wraper admin__content__wrapper">
                                    ...
                                    <div class="dashboard__recent__course dashboard__notice__board">
                                        <div class="dashboard__recent__course__single">
                                            <div class="dashboard__recent__course__img">
                                                <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/blog/blog_6.png" alt="grid"></a>
                                            </div>
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                    ...
                                    <div class="dashboard__recent__course dashboard__notice__board">
                                        <div class="dashboard__recent__course__single">
                                            <div class="dashboard__recent__course__img">
                                                <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/blog/blog_7.png" alt="grid"></a>
                                            </div>
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                    ...
                                    <div class="dashboard__recent__course dashboard__notice__board">
                                        <div class="dashboard__recent__course__single">
                                            <div class="dashboard__recent__course__img">
                                                <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/blog/blog_8.png" alt="grid"></a>
                                            </div>
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                    ...
                                    <div class="dashboard__recent__course dashboard__notice__board">
                                        <div class="dashboard__recent__course__single">
                                            <div class="dashboard__recent__course__img">
                                                <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/blog/blog_9.png" alt="grid"></a>
                                            </div>
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                    ...
                                    <div class="dashboard__recent__course dashboard__notice__board">
                                        <div class="dashboard__recent__course__single">
                                            <div class="dashboard__recent__course__img">
                                                <a href="../course-details.html"><img loading="lazy"  src="<?=base_url()?>public/new/img/blog/blog_4.png" alt="grid"></a>
                                            </div>
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                                <div class="dashboard__content__wraper admin__content__wrapper">
                                    ...
                                    <div class="dashboard__popular__instructor dashboard__notificatoin__wrap">
                                        ...
                                        <div class="dashboard__popular__instructor__single">
                                            <div class="dashboard__popular__instructor__img">
                                                <img loading="lazy"  src="<?=base_url()?>public/new/img/dashbord/profile.png" alt="">
                                            </div>
                                            <div class="dashboard__popular__instructor__content">
                                                <h4>
                                        ...
                                        <div class="dashboard__popular__instructor__single">
                                            <div class="dashboard__popular__instructor__img">
                                                <img loading="lazy"  src="<?=base_url()?>public/new/img/dashbord/lock.png" alt="">
                                            </div>
                                            <div class="dashboard__popular__instructor__content">
                                                <h4>
                                        ...
                                        <div class="dashboard__popular__instructor__single">
                                            <div class="dashboard__popular__instructor__img">
                                                <img loading="lazy"  src="<?=base_url()?>public/new/img/dashbord/verify.png" alt="">
                                            </div>
                                            <div class="dashboard__popular__instructor__content">
                                                <h4>
                                        ...
                                        <div class="dashboard__popular__instructor__single">
                                            <div class="dashboard__popular__instructor__img">
                                                <img loading="lazy"  src="<?=base_url()?>public/new/img/dashbord/success.png" alt="">
                                            </div>
                                            <div class="dashboard__popular__instructor__content">
                                                <h4>
                                        ...
                                        <div class="dashboard__popular__instructor__single">
                                            <div class="dashboard__popular__instructor__img">
                                                <img loading="lazy"  src="<?=base_url()?>public/new/img/dashbord/video.png" alt="">
                                            </div>
                                            <div class="dashboard__popular__instructor__content">
                                                <h4>
