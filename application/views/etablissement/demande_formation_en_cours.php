...
<div class="col-xl-9 col-lg-9 col-md-12">
                            <div class="dashboard__content__wraper">
                                <div class="dashboard__section__title" style="display: flex;align-items:center;justify-content:space-between;">
                                    <h4>Liste Des Demandes <span style="font-size:17px; font-family:cursive">(Formation)</span></h4>
      ...
      <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content bd-0 tx-14 loginarea__wraper" style="border:none !important;">
                <div class="modal-header login__heading">
                                    <h5 class="login__title">Accepter La Demande Pour Cette Formation</h5>
                </div>
                <div style="display:flex;align-items: center;justify-content: space-between;">
                     <a id="demandFormation" class="default__button" style="margin-top:15px" href="#">Accepter</a>
...
window.addEventListener('load',function() {
    ...
    manageModuleTable = $("#manageModuleTable").DataTable({
        ...
        'ajax': 'formation/fetchNotAcceptedDemandesFormationDept',
...
function acceptDemande(demandeId){
    ...
    $('#demandFormation').unbind('click').on('click',e=>{
            e.preventDefault()
            overlayOn()
            fetch('<?=base_url()?>formation/acceptDemand/'+demandeId).then(data=>{
                return data.json()
            }).then(data=>{
                        if(data.success){
                            Swal.fire({
