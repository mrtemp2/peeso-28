                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6" data-aos="fade-up">
                        <div class="aboutarea__5__img" data-tilt>
                            <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/about/about_14.png" alt="about">
                        </div>
                    </div>
                        ...
                        <div class="aboutarea__content__wraper__5">
                            ...
                            <div class="aboutarea__5__small__icon__wraper">
                                <div class="aboutarea__5__small__icon">
                                    <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/about/about_15.png" alt="about">
                        ...
                        <div class="tab-pane fade" id="projects__two" role="tabpanel" aria-labelledby="projects__two">
                            ...
                            <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                <div class="gridarea__img">
                                    <a href="course-details.html"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_1.png" alt="grid"></a>
                            ...
                            <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                <div class="gridarea__img">
                                    <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_2.png" alt="grid">
                                    <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                <div class="gridarea__img">
                                    <a href="course-details.html"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_3.png" alt="grid"></a>
                                    <div class="gridarea__small__button">
                                ...
                                <div class="aboutarea__content__tap__wraper">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="single__event__wraper single__award" data-aos="fade-up">
                                                <div class="eventarea__img">
                                                    <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/about/award-1.jpg" alt="event">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="single__event__wraper single__award" data-aos="fade-up">
                                                <div class="eventarea__img">
                                                    <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/about/award-2.jpg" alt="event">
                                                </div>
                                                <div class="eventarea__content__wraper">
                                                    <div class="single__event__heading">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="single__event__wraper single__award" data-aos="fade-up">
                                                <div class="eventarea__img">
                                                    <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/about/award-3.jpg" alt="event">
                                                </div>
                                                <div class="eventarea__content__wraper">
                                                    <div class="single__event__heading">
                                                        <h4><a href="event-details.html">Forging relationships between national</a></h4>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="single__event__wraper single__award" data-aos="fade-up">
                                                <div class="eventarea__img">
                                                    <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/about/award-4.jpg" alt="event">
                                                </div>
                                                <div class="eventarea__content__wraper">
                                                    <div class="single__event__heading">
                                                        <h4><a href="event-details.html">Lorem ipsum dolor sit amet conse ctetur.</a></h4>
                ...
                <div class="row about__course__slider__active row__custom__class">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_7.png" alt="grid"></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_8.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                                    <div class="grid__badge">Data & Tech</div>
                                </div>
                                <div class="gridarea__small__icon">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_9.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                                    <div class="grid__badge">Data & Tech</div>
                                </div>
                                <div class="gridarea__small__icon">
                        ...
                        <div class="single__testimonial__wraper">
                            <div class="single__testimonial__inner">
                                <div class="testimonial__img">
                                    <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/testimonial/testi_1.png" alt="testi">
                ...
                <div class="row">
                    <div class="brandarea__wraper" data-aos="fade-up">
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_1.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_2.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_3.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_4.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_5.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_6.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_7.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_8.png" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/brand/brand_9.png" alt="brand"></a>
                        </div>
                    </div>
                </div>
