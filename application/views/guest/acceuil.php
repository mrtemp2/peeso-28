        ...
        $conseillers = $this->model_tuteur->getALLTuteur();
        $competitions = $this->model_news->fetchDataCompetitons();
        $formations = $this->model_formation->getAllFormations();
        $etab_id = $this->session->userdata('etab_id');
        if ($etab_id) {
            // Do something with $etab_id if it has a value
            $etab_id = $this->session->userdata('etab_id');
            $actualite = $this->model_news->news_section_etab($etab_id);
            //i'm no so sure about this poinnt wating for more information
            //$conseillers = $this->model_tuteur->getALLTuteur();
            $competitions = $this->model_news->fetchDataCompetitons($etab_id);
            $formations = $this->model_formation->getAllFormations_etab($etab_id);
        } 
        ...
        <style>
            .custom__user__box {
                ...
                border: 2px solid transparent; /* Light border */
                padding: 20px; /* Space inside the box */
                border-radius: 10px; /* Rounded corners */
                
                height: 100%; /* Match the height of the left section */
            }

            .custom__review__grid {
                margin-bottom: 15px; /* Space between user cards */
            }

            .aboutarea__img__3 img {
        ...
        <div class="herobannerarea herobannerarea__box" style="height: 400px !important;">
            <div class="container">
                        ...
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="herobannerarea__title">
                                ...
                                <div class="herobannerarea__title__heading__2">
                                    <h2 style="font-size: 30px !important; line-height:40px !important">Bienvenu dans votre Platforme 4C</h2>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="aboutarea__img__inner text-center">
                            <div class="aboutarea__img" data-tilt>
                                <img loading="lazy"  class="aboutimg__1" src="<?php echo base_url() ?>public/new/img/about/about_8.png" height="400" alt="aboutimg">
                                <img loading="lazy"  class="aboutimg__2" src="<?php echo base_url() ?>public/new/img/about/about_1.png" height="350" alt="aboutimg">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="herobannerarea__icon">
                <img loading="lazy"  class="hero__icon__1" src="<?php echo base_url() ?>public/new/img/register/register__2.png" alt="photo">
                <img loading="lazy"  class="hero__icon__2" src="<?php echo base_url() ?>public/new/img/herobanner/herobanner__6.png" alt="photo">
                <img loading="lazy"  class="hero__icon__3" src="<?php echo base_url() ?>public/new/img/herobanner/herobanner__7.png" alt="photo">
                <img loading="lazy"  class="hero__icon__4" src="<?php echo base_url() ?>public/new/img/herobanner/herobanner__7.png" alt="photo">
            </div>
        </div>
        ...
        <div class="brandarea__2">
            <div class="container">
                <div class="row" data-aos="fade-up" style="width:90%;justify-self:center;">
                    <div class="brandarea__wraper brandarea__wraper__2">
                        <div class="brandarea__img">
                            <a href="https://www.ccicentre.org.tn/" target="_blank"><img loading="lazy"  src="<?php echo base_url() ?>public/images/partners/logo-ccic.png" width="120" height="60" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="https://www.novationcity.com/novation-city/" target="_blank"><img loading="lazy"  src="<?php echo base_url() ?>public/images/partners/novation.jpeg" width="120" height="60" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="https://services-oouc.rnu.tn/fr/etudiant/login" target="_blank"><img loading="lazy"  src="<?php echo base_url() ?>public/images/partners/avatar.png" width="80" height="60" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="https://www.emploi.nat.tn/fo/Fr/global.php" target="_blank"><img loading="lazy"  src="<?php echo base_url() ?>public/images/partners/Aneti_tunisie.png" width="120" height="60" alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="https://www.tunisieindustrie.nat.tn/fr/home.asp" target="_blank"><img loading="lazy"  src="<?php echo base_url() ?>public/images/partners/L'Agence-de-Promotion-de-l'Industrie-et-Innovation.png" width="100" height="60" alt="brand"></a>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2">
                            <div class="educationarea__img" data-tilt>
                                <img loading="lazy"  class="aboutarea__2__img__1" src="<?php echo base_url() ?>public/new/img/about/grad.png" width="450" height="484" alt="education">
                                <img loading="lazy"  class="aboutarea__2__img__2" src="<?php echo base_url() ?>public/new/img/about/about_3.png" alt="education">
                                <img loading="lazy"  class="aboutarea__2__img__3" src="<?php echo base_url() ?>public/new/img/about/about_4.png" alt="education">
                                <img loading="lazy"  class="aboutarea__2__img__4" src="<?php echo base_url() ?>public/new/img/about/about_11.png" alt="education">
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        ...
                        <div class="aboutarea__content__wraper">
                            <div class="aboutarea__button">
                                <div class="default__small__button">À propos de nous</div>
                            </div>
                            <div class="aboutarea__headding heading__underline">
                                <h2>Bienvenu Dans <span>Votre Platforme</span> 4C</h2>
                            </div>
                            ...
                            <div class="aboutarea__list__2">
                                <ul>
                                    <li>
                                        <i class="icofont-check"></i> Formation et Certification
                                    </li>

                                    <li>
                                        <i class="icofont-check"></i> Conseil, informations et renseignement
                                    </li>

                                    <li>
                                        <i class="icofont-check"></i> Offres de stages et d'emploi
                                    </li>
                                    <li>
                                        <i class="icofont-check"></i> Activités estudiantines des clubs et assocaitions
                                    </li>
                                    <li>
                                        <i class="icofont-check"></i> Mobilité internationale
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                        <div class="counterarea__text__wraper">
                            <div class="counter__img">
                                <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/counter/counter__1.png" alt="counter">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                        <div class="counterarea__text__wraper">
                            <div class="counter__img">
                                <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/counter/counter__2.png" alt="counter">
                            </div>
                            <div class="counter__content__wraper">
                                <div class="counter__number">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                        <div class="counterarea__text__wraper">
                            <div class="counter__img">
                                <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/counter/counter__3.png" alt="counter">
                            </div>
                            <div class="counter__content__wraper">
                                <div class="counter__number">
                                ...
                                <p>Total Conseillers</p>

                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                        <div class="counterarea__text__wraper" style="width: max-content;">
                            <div class="counter__img">
                                <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/counter/counter__4.png" alt="counter">
                            </div>
                            <div class="counter__content__wraper">
                                <div class="counter__number">
                                ...
                                <p>Structures d'appui/Entreprises</p>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 about__wrap__content" data-aos="fade-up">
                        <div class="service__animate__shape__1">
                            <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/service/service__shape__1.png" alt="">
                        </div>
                        <div class="populerarea__content__wraper__2">
                            <div class="section__title ">
                                <div class="section__title__button">
                                    <div class="default__small__button">Sujet populaire</div>
                                </div>
                                <div class="section__title__heading">
                                    <h2>Offres Stages & Emploi
                                        <br> Conseils, Informations et Renseignement</h2>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 service__wrap__content">
                        <div class="service__animate__shape__2">
                            <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/service/service__shape__bg__1.png" alt="">
                        </div>
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service">
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.html">Offres de stages et d'emploi</a></h3>
                                        <p>Construction is a general term the art and science to form </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="<?= base_url()?>stage_emploi">View Subject
                                        <i class="icofont-long-arrow-right"></i>
                                    </a>
                                    </div>
                                ...
                                <rect x="28" y="11.5198" width="8" height="0.993319" fill="#FFB31F"/>
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.html">Formations et Certifications</a></h3>
                                        <p>Construction is a general term the art and science to form </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="#">View Subject
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service ss_margin">
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.html">Mobilité internationale</a></h3>
                                        <p>Construction is a general term the art and science to form </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="#">View Subject
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M26.9989 7.6293L23.05 18.137L20.3744 15.4678C15.622 19.6266 9.96272 22.5976 3.63238 24.2568C1.36694 24.9297 0.353173 21.6176 2.74495 21.0505C8.47735 19.533 13.5443 16.8156 17.8363 13.1279L15.5453 10.8879L26.9989 7.6293Z" fill="#FFB31F"/>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M63.3775 44.4535C54.8582 58.717 39.1005 53.2202 23.1736 47.5697C7.2467 41.9192 -5.18037 32.7111 3.33895 18.4477C11.8583 4.18418 31.6595 -2.79441 47.5803 2.85105C63.5011 8.49652 71.8609 30.2313 63.3488 44.4865L63.3775 44.4535Z" fill="#5F2DED" fill-opacity="0.05"/>
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.html">Clubs et Associations</a></h3>
                                        <p>Construction is a general term the art and science to form </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="<?= base_url() ?>register">S'inscrire
                                            <i class="icofont-long-arrow-right"></i>
                                        </a>
                                    </div>
                                    <div class="service__small__img">
        ...
        <div class="gridarea gridarea__2">
            <div class="container">
                <div class="row grid__row">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12" data-aos="fade-up">
                        <div class="section__title__2">
                            <div class="section__title__button">
                                <div class="default__small__button">Nos Activités</div>
                            </div>
                            <div class="section__title__heading__2 section__title__heading__3 heading__fontsize__2">
                                <h2 style="font-size: 30px !important;">Compétitions & Formations & Coaching</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12" data-aos="fade-up">
                        <div class="gridfilter_nav grid__filter__2 gridFilter">
                            <button class="active" data-filter=".filter1" class="">Compétitions </button>
                            <button data-filter=".filter2" class="">Formations </button>
                            <button data-filter=".filter3" class="">Coaching </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row grid" data-aos="fade-up">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 ">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"  src="<?php echo $competition['photo']  ?>" width="200" height="250" alt="grid"></a>
                                ...
                                <div class="gridarea__list">
                                    <ul>
                                        ...
                                        <li style="white-space: nowrap;">
                                            <i class="icofont-clock-time"></i> <?php echo $competition['date_debut'].'/'.$competition['date_fin'] ?>
                                        </li>
                                    </ul>
                                </div>
                                <div class="gridarea__heading">
                                    <h3><a href="course-details.html"><?php echo $competition['nom'] ?></a></h3>
                                </div>
                                ...
                                <div class="gridarea__bottom">
                                    ...
                                    <!-- <a href="instructor-details.html">
                                        <div class="gridarea__small__img">
                                            <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_small_1.jpg" alt="grid">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter2">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <img loading="lazy"  src="<?php echo base_url().$formation['thumbnail'] ?>" width="200" height="250" alt="grid">
                                <div class="gridarea__small__button">
                                    <div class="grid__badge blue__color"><?= $formation['nom_dom']?></div>
                                </div>
                                <div class="gridarea__small__icon">
                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                </div>
                            ...
                            <div class="gridarea__content">
                                <div class="gridarea__list">
                                    <ul>
                                        <li>
                                            <i class="icofont-book-alt"></i> <?= $formation['nb_seance'].' séances' ?>
                                        </li>
                                        <li style="white-space: nowrap;">
                                            <i class="icofont-clock-time"></i> <?= $formation['date_debut'].'/'.$formation['date_fin'] ?>
                                        </li>
                                    </ul>
                                </div>
                                <div class="gridarea__heading">
                                    <h3><a href="#"><?= $formation['nom'] ?></a></h3>
                                </div>
                                ...
                                <div class="gridarea__bottom">
                                    <a href="instructor-details.html">
                                        <div class="gridarea__small__img">
                                            <img loading="lazy"  src="<?= $formation['photo_ref'] ? base_url('assets/assets/images/'.$formation['photo_ref']) : base_url('public/new/img/about/user.png') ?>"  alt="grid">
                                            <div class="gridarea__small__content">
                                                <h6><?= $formation['nom_ref'] ?></h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- <div class="gridarea__star">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_5.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__bottom">
                                    ...
                                    <a href="instructor-details.html">
                                        <div class="gridarea__small__img">
                                            <img loading="lazy"  src="<?php echo base_url() ?>public/new/img/grid/grid_small_5.jpg" alt="grid">
                                            <div class="gridarea__small__content">
                                                <h6>Micle Robin</h6>
                                            </div>
                                        </div>
        ...
        <div class="registerarea sp_top_90">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="registerarea__wraper">
                            <div class="section__title registerarea__section__title">
                                <div class="section__title__button">
                                    <div class="default__small__button">Structure D'appui</div>
                                </div>
                                <div class="section__title__heading heading__underline">
                                    <h2>Enregistrez votre <span>Compte </span>Obtenez un accès gratuit à <small>+500</small>
                            ...
                            <div class="registerarea__content">
                                <div class="registerarea__video">
                                    <div class="video__pop__btn">
                                        <a class="video-btn" href="https://www.youtube.com/watch?v=7BOKK1qBXK0"> <img loading="lazy" 
                                                src="<?php echo base_url() ?>public/new/img/icon/video.png" alt=""></a>
                                    </div>
                                    <div class="registerarea__para">
                                        <p>Inauguration du nouveau Pôle de l’Étudiant Entrepreneur de l’Université de Sousse (Tunisie)
                                        </p>
                                    </div>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="registerarea__form">
                            <div class="registerarea__form__heading">
                                <h4>Remplissez votre inscription</h4>
                            </div>
                            <form action="#">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <input class="register__input" type="text" placeholder="Nom">
                                    </div>
                                    <div class="col-xl-6">
                                        <input class="register__input" type="text" placeholder="Prénom">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-6">
                                    ...
                                    <div class="col-xl-6">
                                        <input class="register__input" type="text" placeholder="Téléphone">
                                    </div>
                                </div>
                                <input class="register__input" type="text" placeholder="Raison Sociale">
                                <select class="register__input" name="type_str" id="type_str" style="color:#767676">
                                    <option value="">Type Établissement</option>
                                ...
                                <div class="registerarea__button">
                                    <a class="default__button" href="#">S'inscrire
                                        <i class="icofont-long-arrow-right"></i>
                                    </a>
                                </div>
                            </form>
            ...
            <div class="registerarea__img">
                <img loading="lazy"  class="register__1" src="<?php echo base_url() ?>public/new/img/register/register__1.png" alt="register">
                <img loading="lazy"  class="register__2" src="<?php echo base_url() ?>public/new/img/register/register__2.png" alt="register">
                <img loading="lazy"  class="register__3" src="<?php echo base_url() ?>public/new/img/register/register__3.png" alt="register">
            </div>
        </div>
        <!-- register__section__start-->
        ...
        <div class="aboutarea__3 testimonial__area__2 sp_bottom_90 sp_top_120">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                        <div class="section__title aboutarea__3__section__title">
                            <div class="section__title__button">
                                <div class="default__small__button">Nos Conseillers</div>
                            </div>
                            <div class="section__title__heading">
                                <h2>Liste de Nos
                                    <br>Conseillers</h2>
                        ...
                        <div class="aboutarea__3__content">
                            <p>Le 4C peut faire partie d'une communauté qui repose sur l'échange d'experiences, ceci grâce aux outils de communication 
                                avec nos conseillers </p>
                        </div>
                    ...
                    <!-- Users Section Inside Box -->
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 custom__user__box">
                        <div class="row">
                            <?php 
                            $counter = 0;
                            foreach ($conseillers as $conseiller) { ?>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                                    <div class="aboutarea__content__wraper__3">
                                        <div class="aboutarea__img__3">
                                            <img loading="lazy" src="<?= $conseiller['photo'] ? base_url('assets/assets/images/'.$conseiller['photo']) : base_url('public/new/img/about/user.png') ?>" width="50" height="50" alt="about">
                                            <div class="aboutarea__img__name">
                                                <h6><?= $conseiller['prenom'] . ' ' . $conseiller['nom'] ?></h6>
                                                <p><?= $conseiller['domaine'] ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="aboutarea__img__3">
                <img loading="lazy"  class="aboutarea__3__img__1" src="<?php echo base_url() ?>public/new/img/about/about_6.png" alt="about">
                <img loading="lazy"  class="aboutarea__3__img__2" src="<?php echo base_url() ?>public/new/img/about/about_7.png" alt="about">
                <img loading="lazy"  class="aboutarea__3__img__3" src="<?php echo base_url() ?>public/new/img/about/about_9.png" alt="about">
            </div>
        </div>
        ...
        <div class="blogarea sp_bottom_70 sp_top_100">
            <div class="container">
                <div class="row" data-aos="fade-up">
                    <div class="col-xl-12">
                        <div class="section__title text-center">
                            <div class="section__title__button">
                                <div class="default__small__button">Actualités</div>
                            </div>
                            <div class="section__title__heading">
                ...
                <div class="row">
                    <?php if (!empty($actualite) && is_array($actualite)): ?>
                        <!-- Main News -->
                        <div class="col-xl-8 col-lg-8" data-aos="fade-up">
                            <?php $mainNews = array_shift($actualite); // Get the first news for the main section ?>
                            <div class="blogarea__content__wraper">
                                <div class="blogarea__img">
                                    <img loading="lazy" src="<?php echo base_url() ?>assets/assets/images/<?php echo $mainNews['image']; ?>" alt="blog">
                                    <div class="blogarea__date">
                                        <?php 
                                            $date = date_create($mainNews['created_at']); 
                                ...
                                <div class="blogarea__text__wraper">
                                    <h3><a href="<?php echo base_url() ?>actualite"><?php echo $mainNews['titre']; ?></a></h3>
                                    <div class="blogarea__para">
                                        <p><?php echo $mainNews['content']; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4" data-aos="fade-up">
                            <?php foreach ($actualite as $news): ?>
                                <div class="blogarea__content__wraper">
                                    <div class="blogarea__img">
                                        <img loading="lazy" src="<?php echo base_url() ?>assets/assets/images/<?php echo $news['image']; ?>" alt="blog">
                                    ...
                                    <div class="blogarea__text__wraper blogarea__text__wraper__2">
                                        <h3><a href="<?php echo base_url() ?>actualite"><?php echo $news['titre']; ?></a></h3>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
