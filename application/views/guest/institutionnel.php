<?php 
$etabs = $this->model_clubs->get_clubs_by_type_institutionnelle();
?>
<style>
            .card {
                background: #fff;
                    ...
                    <div class="col-xl-12">
                        <div class="breadcrumb__content__wraper" data-aos="fade-up">
                            <div class="breadcrumb__title">
                                <h2 class="heading">Club institutionnel</h2>
                            </div>
                            <div class="breadcrumb__inner">
                                <ul>
                                    <li><a href="<?= base_url() ?>">Home</a></li>
                                    <li>Club institutionnel</li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><?= $etab['nom_du_club'] ?></p>
                            <a href="javascript:void(0);" class="btn btn-primary" onclick="ViewSubject(<?= $etab['id'] ?>)">Voir plus</a>
