...
$evenement = $this->model_rapport_activite->get_rapport_by_club($club_id);
        ...
        <div class="col-xl-12">
            <div class="breadcrumb__content__wraper" data-aos="fade-up">
                <div class="breadcrumb__title">
                    <h2 class="heading">Evenements de <?php echo htmlspecialchars($club["nom_du_club"]); ?></h2>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 aos-init aos-animate" data-aos="fade-up">
                    <div class="gridarea__wraper gridarea__wraper__2">
                        <div class="gridarea__img">
                            <a href="#"><img loading="lazy" src="<?= base_url()."public/new/images/dashboard/pdf.png" ?>" alt="grid"></a>
                        ...
                        <div class="gridarea__content">
                            <div class="gridarea__list">
                                <ul>
                                    <li><i class="icofont-clock-time"></i> <?= htmlspecialchars($event['annee']); ?></li>
                                </ul>
                            </div>
                            <div class="gridarea__heading">
                                <h3><a href="#"><?= htmlspecialchars($event['nom']); ?></a></h3>
                            </div>
                            <p><?= htmlspecialchars($event['description']); ?></p>
                            <a class="default__button" style="margin-top:15px;width:100%" href="<?= base_url('assets/assets/images/'. $event['pdf']); ?>" target="_blank">Télécharger le PDF</a>
                        </div>
                    </div>
                </div>
                <!-- End Event Card -->
