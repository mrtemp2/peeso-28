                    ...
                    <div class="col-xl-12">
                        <div class="breadcrumb__content__wraper" data-aos="fade-up">
                            <div class="breadcrumb__title">
                                <h2 class="heading">Appel à Candidature</h2>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="blogsidebar__content__wraper__2" data-aos="fade-up">
                            <h4 class="sidebar__title">Appels à Candidature Récents</h4>
                        <?php foreach($appel as $a) {?>
                            <ul class="recent__list">
                                <li>
                                    <div class="recent__img">
                                        <a href="#">
                                            <img loading="lazy"  src="<?= $a['photo']  ?>" alt="sidbar">
                                        </a>
                                    </div>
                                    ...
                                    <div class="recent__text">
                                        ...
                                        <div class="recent__date">
                                            <a href="#"><?= $a['date_debut']  ?></a>
                                        </div>

                                        <h6><a href="#"><?= $a['nom'] ?> </a></h6>
            ...
            <div class="modal-content" style="transform: none;">
                ...
                <div class="modal-body" style="transform: none;">
                    <div class="blog-listing-content">
                        ...
                        <h5 id="sujet" style="text-align:center"></h5>
    ...
    <script>
        function readMore(appel_id) {
            
            // Check if theme is dark or if no theme is set and prefers dark mode
            if (localStorage.getItem("theme-color") === "dark" || 
                (!("theme-color" in localStorage) && window.matchMedia("(prefers-color-scheme: dark)").matches)) {
                $(".modal-header").css("background-color", "#34495e");
                $(".modal-body").css("background-color", "#34495e"); 
            } 
            ...
            fetch(`appel_candidature/getAppels/${appel_id}`)
                ...
                .then(response => {
                    ...
                    if (response.success) {
                        const { nom, sujet, date_fin, domaines_names, photo, description } = response.data; // Access the data correctly
                        console.log(response.data); // Log the data to confirm structure
        ...
        const changePage = (page) => {
            ...
            fetch(`appel_candidature/fetchAppelDispo/${page}`)
                .then((response) => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
