<style>
                    ...
                    <div class="col-xl-12">
                        <div class="breadcrumb__content__wraper" data-aos="fade-up">
                            <div class="breadcrumb__title">
                                <h2 class="heading">Compétition</h2>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="blogsidebar__content__wraper__2" data-aos="fade-up">
                            <h4 class="sidebar__title">Compétitions récentes</h4>
                        <?php foreach($competition as $c) {?>
                            <ul class="recent__list">
                                <li>
                                    <div class="recent__img">
                                        <a href="#">
                                            <img loading="lazy"  src="<?= $c['photo']  ?>" alt="sidbar">
                                        </a>
                                    </div>
                                    ...
                                    <div class="recent__text">
                                        ...
                                        <div class="recent__date">
                                            <a href="#"><?= $c['date_debut']  ?></a>
                                        </div>

                                        <h6><a href="#"><?= $c['nom'] ?> </a></h6>
    ...
    <script>
        function readMore(competition_id) {
            // Show the modal
            $("#exampleModal-login").modal('show');
            fetch(`news/getCompetition/${competition_id}`)
                .then(response => {
                    if (!response.ok) {
                ...
                .then(response => {
                    ...
                    if (response.success) {
                        const { nom, date_fin, photo, description } = response.data; // Access the data correctly
        ...
        const changePage = (page) => {
            ...
            fetch(`news/fetchCompetitionDispo/${page}`)
                .then((response) => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
