...
window.addEventListener('load',function() {
    ...
    manageModuleTable = $("#manageModuleTable").DataTable({
        ...
        'ajax': 'formation/getFormationForEnseignant',
    ...
    $('.js-example-basic-multiple').select2({
                dropdownParent: $('#addFormation'), // Ensure the dropdown is rendered within the modal
                placeholder: "Sélectionnez des domaines",
                width: '100%'
            });
            $('#createFormationForm').on('submit',function (e){
                e.preventDefault()
...
function ajouterFormation(){
    ...
    overlayOn()
    $('#createFormationContent').load('<?=base_url()?>formation/createFormationReferentContent',(complete)=>{
