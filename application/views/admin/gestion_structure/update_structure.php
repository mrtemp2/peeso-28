...
<div class="modal-content bd-0 tx-14 loginarea__wraper" style="border:none !important;">
        ...
        <div class="modal-header login__heading">
                            <h5 class="login__title">Modifier Compte de Structure D'appui</h5>
        </div>
      
        <form method="post" id="updateStructureForm" action="<?=base_url()?>auth/updateStructureData/<?=$referent['id']?>" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="row">
                    <div class="col-xl-6">
