...
<style>
    ...
    .course-thumbnail-upload-area .incoaching .input-file-type-btn {
    position: relative;
    margin-top: 10px;
    }
    .course-thumbnail-upload-area .incoaching input {
        position: absolute;
        width: 100%;
        height: 100%;
        opacity: 0;
    ...
    .course-thumbnail-upload-area .incoaching button {
        padding: 13px 25px;
    }
</style>
 <div class="col-xl-9 col-lg-9 col-md-12">
                            <div class="dashboard__content__wraper loginarea__wraper">
                                <div class="dashboard__section__title" style="display: flex;align-items:center;justify-content:space-between;">
                                    <h4>Modifier La Session de Coaching</h4>
                                </div>
   
                                    <form method="post" id="updateCoachingForm" action="<?=base_url()?>coaching/updateCoaching/<?=$coaching['id']?>" enctype="multipart/form-data" accept-charset="utf-8">
                                            <div class="row">
                                                    <div class="col-xl-12">
                                                        <div class="login__form">
                                                            <label class="form__label">Titre</label>
                                                            <input class="common__login__input" type="text" value="<?=$coaching['nom']?>" name="nom" id="nom" placeholder="Nom">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="login__form">
                                                            ...
                                                            <input class="common__login__input" type="date" value="<?=$coaching['date_debut']?>" name="date_debut" id="date_debut">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="login__form">
                                                            ...
                                                            <input class="common__login__input" type="date" value="<?=$coaching['date_fin']?>" name="date_fin" id="date_fin">
                                                                ...
                                                                <div class="course-thumbnail-upload-area" style="margin-bottom: 10px;">
                                                                        <?php
                                                                            if(!$coaching['thumbnail']){
                                                                                ...
                                                                                $photo = base_url().'assets/assets/images/'.$coaching['thumbnail'];
                                                                                $fileName = $coaching['thumbnail'];
                                                                            }
                                                                        ?>
                                                                        <div>
                                                                            <img style="height: 100px;" loading="lazy" src="<?=$photo?>" alt="" id="thumbnail_image">
                                                                        </div>
                                                                        <div class="incoaching">
...
<script>
    ...
    window.addEventListener('load',e=>{
        $('.js-example-domaine-multiple').select2({
         ...
         $('#updateCoachingForm').on('submit',function(e){
            ...
            e.preventDefault()
                ...
                fetch(action,{
                    ...
                    if(data.success){
                        ...
                        document.location = '<?=base_url('all_coaching')?>'
                    }
                    else{
                        Swal.fire({
                                icon:'error' ,
