...
<div class="col-xl-9 col-lg-9 col-md-12">
                            <div class="dashboard__content__wraper">
                                <div class="dashboard__section__title" style="display: flex;align-items:center;justify-content:space-between;">
                                    ...
                                    <button class="default__button" style="margin-bottom: 20px;" data-toggle="modal" data-target="#addEtablissement" id="addEtablissementModelBtn" > Ajouter Un Établissement </button>                                </div>
        ...
        <!-- add modal start -->
        <div id="addEtablissement" class="modal fade">
            <div class="modal-dialog modal-lg login-page-form-area" role="document">
              <div class="modal-content bd-0 tx-14" style="border:none !important;">
                ...
                <div class="modal-header pd-y-20 pd-x-25" style="border-bottom:none !important;">
                  <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Ajouter Établissement</h6>
                  
                </div>
               
                  <form method="post" id="createEtabForm" action="etablissement/createEtab" enctype="multipart/form-data" accept-charset="utf-8">
                      ...
                      <div class="row" style="margin:auto;">
                        <div class="col-xl-12">
                          ...
                          <div class="col-xl-12">
                            <div class="contact__input__wraper">
                                <label for="edit_titre_en">Logo de l'Établissement :</label>
                                <div style="
                                    ...
                                    <div class="course-thumbnail-upload-area">
                                        ...
                                        <div class="information">
                                            ...
                                            <div class="input-file-type-btn">
                                                <input type="file" id="real-file" name="logo"  hidden />
    ...
    <div class="modal fade" id="updateSubjectModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog login-page-form-area" role="document">
            <div class="modal-content" style="border:none !important;">
                ...
                <form action="etablissement/updateEtabData" method="post" id="updateEtabForm" enctype="multipart/form-data">
                    <div class="row">
                    <div class="col-xl-12">
                        <div class="contact__input__wraper">
                        <label for="editnom">Nom :</label>
                        <input type="text" id="editnom" name="editnom" placeholder='Nom établissement'>
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="contact__input__wraper">
                            ...
                            ">
                                <div class="course-thumbnail-upload-area">
                                    <div class="thumbnail-area" style="height:100px">
                                        <img id="etab-logo" style="max-height:100%" src="<?= base_url()."public/new/images/dashboard/05.png" ?>" alt="logo">
                                    </div>
                                    <div class="information">
                                        <span>Size: 700 X 430 Pixels</span><br>
                                        <span>File Support: PNG, JPG, JPEG</span>
                                        <div class="input-file-type-btn">
                                            <input type="file" id="real-file-logo" name="edit_logo"  hidden />
    ...
    <div id="removeSubjectModal" class="modal fade">
        ...
        <div class="modal-content tx-size-sm">
            ...
            <h4 class="tx-danger  tx-semibold mg-b-20">Supprimer Établissement</h4>
...
window.addEventListener('load',function() {
    ...
    manageModuleTable = $("#manageModuleTable").DataTable({
        ...
        'ajax': 'etablissement/fetchEtabData',
...
$("#addEtablissementModelBtn").on('click', function() {
            $("#addEtablissement").modal('show');
            $("#createEtabForm")[0].reset();
        $(".form-group").removeClass('has-error').removeClass('has-success');
        $("#messages_add").html('');
        $('.text-danger').remove();
        $("#createEtabForm").unbind("submit").bind("submit", function (event) {
        ...
        function ViewSubject(module_id = null) {
            ...
            fetch(`etablissement/getEtab/${module_id}`, {
                method: 'POST'
            })
            .then(response => response.json()) // Parse the JSON response
            .then(jsonObject => {
                // Build the result HTML string
                let result = "<h6 style='color:#40a4dd; text-align: center;'>Informations de l'établissement</h6>";
                result += "<br><br>";
        ...
        function validateSubject(id,active) {
            ...
            fetch('etablissement/validateEtab/'+id,{
                method:'POST',
                body:formdata
            }).then(data=>{
                ...
                if (response.success == true) {
                    let message = active ? "Établissement activé!" : "Établissement désactivé!";
                    ...
                    let message = isPublished ? "Erreur lors de l'activation de l\'établissement." : "Erreur lors de la désactivation de l\'établissement.";
        ...
        function removeSubject(subjectId = null) {
            ...
            if (subjectId) {
                ...
                $("#removeSubjectBtn").unbind('click').bind('click', function() {
                    ...
                    fetch(`etablissement/removeEtab/${subjectId}`, {
                        method: 'POST',
                        headers: {
